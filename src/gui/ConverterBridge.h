...
public:
    ...
    Q_INVOKABLE QVariantList allFormatsGrouped() const {
        ...
        QList<Group> groups = {
            { "Images",    "qrc:/icons/image.svg",     {"png","jpg","webp","bmp","tiff","gif","heic","avif","exr","hdr","psd","tga","svg","raw","cr2","nef","arw","dng"} },
            { "Video",     "qrc:/icons/video.svg",     {"mp4","mov","avi","mkv","webm","flv","wmv","vob"} },
            { "Audio",     "qrc:/icons/audio.svg",     {"mp3","wav","flac","aac","ogg","opus","m4a","wma","caf"} },
            { "3D Models", "qrc:/icons/3D.svg",        {"fbx","obj","glb","gltf","stl","dae","ply","3ds"} },
            ...
            { "Documents", "qrc:/icons/documents.svg", {"pdf","ai","docx","doc","odt","rtf","xlsx","xls","ods","pptx","ppt","odp","txt","html","md","rst","tex"} },
